...
<form action="{{route('simpan-users')}}" method="post">
  ...
  <div class="mb-3">
    ...
    <input type="email" class="form-control" id="for_nama" name="for_nama" placeholder="Input nama user" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
  ...
  <select class="form-select mb-2" id="for_level_login" aria-label="Default select example">
